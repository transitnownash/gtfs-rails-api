...
class FrequenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should get index' do
    ...
    assert_equal '2000-01-01 06:00:00', json_response['data'][0]['start_time']
    assert_equal '2000-01-01 22:00:00', json_response['data'][0]['end_time']
  ...
  test 'should show frequency' do
    ...
    assert_equal '2000-01-01 06:00:00', json_response['start_time']
    assert_equal '2000-01-01 22:00:00', json_response['end_time']
