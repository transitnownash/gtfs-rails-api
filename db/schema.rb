...
ActiveRecord::Schema[7.0].define(version: 20_220_717_040_631) do
  ...
  create_table 'frequencies', charset: 'utf8mb4', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[trip_gid start_time end_time], name: 'index_frequencies_on_trip_gid_and_start_time_and_end_time',
                                              unique: true
  end
  ...
  create_table 'stop_times', charset: 'utf8mb4', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[trip_gid stop_sequence], name: 'index_stop_times_on_trip_gid_and_stop_sequence', unique: true
  end
  ...
  create_table 'transfers', charset: 'utf8mb4', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[from_stop_gid to_stop_gid], name: 'index_transfers_on_from_stop_gid_and_to_stop_gid', unique: true
  end
